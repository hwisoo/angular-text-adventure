...
export const SCENES: any[] = [
    ...
    //bedroom #6
    new Story("You move to the bedroom. You hear someone calling for help in the closet.", "Do you Help?", ["Go Help.", "Go outside"], [9, 7], 0),
    ...
    new Story("You go to help and find that a raider has tricked you. He knocks you out unconscious", "He takes your weapon and leaves you to die", ["Start Over"], [0], 100),
